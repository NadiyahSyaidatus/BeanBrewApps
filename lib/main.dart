...
import 'package:beanbrewapps/screens/order_screen.dart'; // Import OrdersScreen
...
import 'package:beanbrewapps/screens/checkout_screen.dart'; // Import CheckoutScreen
import 'package:beanbrewapps/models/order.dart';
import 'package:beanbrewapps/screens/tracking_screen.dart'; // Import TrackingScreen
import 'package:beanbrewapps/screens/notifikasi_screen.dart'; // Import NotifikasiScreen
...
class BeanBrewApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LoginScreen(), // Set login screen as the initial route
      routes: {
        ...
        '/notifikasi': (context) => NotifikasiScreen(), // Menambahkan route untuk NotifikasiScreen
      ...
      onGenerateRoute: (settings) {
        if (settings.name == '/category') {
          ...
          return MaterialPageRoute(
            builder: (context) {
              return OrdersScreen(); // Menggunakan OrdersScreen di sini
            },
          );
        }
        return null;
